           ...
           <div class="container">
              <div class="row">
                 ...
                 <div class="col-md-4 col-sm-6">
                    <div class="reader">
                       <a href="index.html"><img src="{{url('frontend/images/logo_footer.png')}}" alt="#"/></a>
                 ...
                 <div class="col-md-3 col-sm-6">
                    <div class="reader">
                       <h3>Recent Posts</h3>
                       <ul class="re_post">
                          <li><img src="{{url('frontend/images/re_img1.jpg')}}" alt="#"/></li>
                          <li><img src="{{url('frontend/images/re_img2.jpg')}}" alt="#"/></li>
                          <li><img src="{{url('frontend/images/re_img3.jpg')}}" alt="#"/></li>
                          <li><img src="{{url('frontend/images/re_img4.jpg')}}" alt="#"/></li>
                       </ul>
                    </div>
                 </div>
                 <div class="col-md-3 col-sm-6">
